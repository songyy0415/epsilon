...
QUIZ_CASE(pcj_exact_and_approximate_are_equal) {
  QUIZ_ASSERT(ExactAndApproximateExpressionsAreStriclyEqual(2_e, 2.0_fe));
  QUIZ_ASSERT(ExactAndApproximateExpressionsAreStriclyEqual(-2_e, -2.0_fe));
  QUIZ_ASSERT(ExactAndApproximateExpressionsAreStriclyEqual(1_e / 2_e, 0.5_fe));
  QUIZ_ASSERT(!ExactAndApproximateExpressionsAreStriclyEqual(
