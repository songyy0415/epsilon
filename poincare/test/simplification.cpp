...
QUIZ_CASE(pcj_simplification_parametric) {
  ...
  simplifies_to("sum((-1)^k/(2k+1), k, 0, 255)",
                ...
                "50521262557831908410730478981322434654472315038287272753268645"
                "0945750584158869339254516708374272/"
                "23628176390441709242549377774050960991037432142720306358190075"
                "70184928024196838751160477994380962295118106133032052945970545"
                "94844841822607437569698157696931361116784801218847841677611688"
                "4971020842497182471788854208479125");
  simplifies_to(
      "sum((-1)^k/(2k+1), k, 0, 300)",
      "786818407988354235898273807970836155662532005379006128476992728511676779"
      "319683331968079377390846401393922856975336929073205254664820293824965401"
      "976472754002286769459105480532909584643371905080032383762016124302185814"
      "180529512860826461970337308318066108010997/"
      "100075001342385956382017803393534664706450382951179658067705495699726083"
      "773279230734332631734594922266009087218756028754509689976658171913955452"
      "876211606739179848513105100359998521959307448291826000026281852131845567"
      "2915323135522196723199336910693508934511625");
  simplifies_to("sum((-1)^k/(2k+1), k, 0, 400)", "sum((-1)^k/(2×k+1),k,0,400)");
