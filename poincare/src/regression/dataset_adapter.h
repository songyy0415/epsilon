...
class OneColumn : public Internal::StatisticsDataset<double> {
 public:
...
class DatasetSeriesAdapter : public Internal::StatisticsDataset<double> {
 public:
  ...
  double columnProductSum(CalculationOptions options) const {
    double result = 0;
  ...
  double covariance(CalculationOptions options) const {
