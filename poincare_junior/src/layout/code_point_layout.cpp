...
void CodePointLayout::GetName(const Node node, char * buffer, size_t bufferSize) {
...
void CodePointLayout::RenderNode(const Node node, KDContext * ctx, KDPoint p, KDFont::Size font, KDColor expressionColor, KDColor backgroundColor) {
  ...
  ctx->drawString(buffer, p, KDGlyph::Style{
