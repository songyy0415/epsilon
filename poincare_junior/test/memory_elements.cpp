  ...
  std::pair<BlockType, TypeBlockProperties> blockTypeTests[] = {
      ...
      std::make_pair(BlockType::DoubleFloat,
                     TypeBlockProperties{.nAry = false,
                                         ...
                                         .number = true,
                                         .userNamed = false}),
      std::make_pair(BlockType::Decimal,
                     TypeBlockProperties{.nAry = false,
                                         .expression = true,
                                         .layout = false,
                                         .integer = false,
      ...
      std::make_pair(BlockType::Set, TypeBlockProperties{.nAry = true,
                                                         ...
                                                         .number = false,
                                                         .userNamed = false}),
      std::make_pair(BlockType::Matrix,
                     TypeBlockProperties{.nAry = false,
                                         .expression = true,
                                         .layout = false,
                                         .integer = false,
      ...
      std::make_pair(BlockType::Power, TypeBlockProperties{.nAry = false,
                                                           ...
                                                           .number = false,
                                                           .userNamed = false}),
      std::make_pair(BlockType::PowerReal,
                     TypeBlockProperties{.nAry = false,
                                         .expression = true,
                                         .layout = false,
                                         .integer = false,
                                         ...
                                         .number = false,
                                         .userNamed = false}),
      std::make_pair(BlockType::Abs, TypeBlockProperties{.nAry = false,
                                                         .expression = true,
                                                         .layout = false,
                                                         .integer = false,
                                                         .rational = false,
      ...
      std::make_pair(BlockType::Logarithm,
                     TypeBlockProperties{.nAry = false,
                                         ...
                                         .number = false,
                                         .userNamed = false}),
      std::make_pair(BlockType::Log, TypeBlockProperties{.nAry = false,
                                                         .expression = true,
                                                         .layout = false,
                                                         .integer = false,
                                                         .rational = false,
                                                         .number = false,
                                                         .userNamed = false}),
      std::make_pair(BlockType::Ln, TypeBlockProperties{.nAry = false,
                                                        .expression = true,
                                                        .layout = false,
                                                        .integer = false,
                                                        .rational = false,
                                                        .number = false,
                                                        .userNamed = false}),
      std::make_pair(BlockType::Derivative,
                     TypeBlockProperties{.nAry = false,
                                         .expression = true,
                                         .layout = false,
                                         .integer = false,
      ...
      std::make_pair(BlockType::Trig, TypeBlockProperties{.nAry = false,
                                                          ...
                                                          .number = false,
                                                          .userNamed = false}),
      std::make_pair(BlockType::TrigDiff,
                     TypeBlockProperties{.nAry = false,
                                         .expression = true,
                                         .layout = false,
                                         .integer = false,
      ...
      std::make_pair(BlockType::VerticalOffsetLayout,
                     TypeBlockProperties{.nAry = false,
                                         ...
                                         .number = false,
                                         .userNamed = false}),
      std::make_pair(BlockType::AsciiCodePointLayout,
                     TypeBlockProperties{.nAry = false,
                                         .expression = false,
                                         .layout = true,
                                         .integer = false,
...
QUIZ_CASE(pcj_constructor) {
  assert_tree_equals_blocks(
             ...
             KSuperscriptL("2"_l), "-2"_l),
      {
          ...
          ValueBlock(2),
          ValueBlock(0),
          TypeBlock(BlockType::AsciiCodePointLayout),
          ValueBlock('1'),
          TypeBlock(BlockType::AsciiCodePointLayout),
          ValueBlock('+'),
