...
using CoefficientsType = Poincare::Regression::Regression::CoefficientsType;
...
QUIZ_CASE(regression_linear) {
  ...
  constexpr CoefficientsType coefficientsAxpb = {3.4, -7.0};
  constexpr CoefficientsType coefficientsApbx = {-7.0, 3.4};
...
QUIZ_CASE(regression_linear_2) {
  ...
  constexpr CoefficientsType coefficientsAxpb = {3.31824, 18.1191};
  constexpr CoefficientsType coefficientsApbx = {18.1191, 3.31824};
...
QUIZ_CASE(regression_proportional) {
  ...
  constexpr CoefficientsType coefficients = {-5.89};
...
QUIZ_CASE(regression_proportional_2) {
  ...
  constexpr CoefficientsType coefficients = {2.12963963};
...
QUIZ_CASE(regression_proportional_3) {
  ...
  static_assert(std::size(x) == std::size(y), "Column sizes are different");
  constexpr CoefficientsType coefficients = {0.0};
  constexpr double r2 = 1.0;
...
QUIZ_CASE(regression_quadratic) {
  ...
  static_assert(std::size(x) == std::size(y), "Column sizes are different");
  constexpr CoefficientsType coefficients = {-6.50001, 21.3004, -3.15799};
  constexpr double r2 = 1.0;
...
QUIZ_CASE(regression_cubic) {
  ...
  static_assert(std::size(x) == std::size(y), "Column sizes are different");
  constexpr CoefficientsType coefficients = {-21.2015, 16.0141, 4.14522,
                                             -12.8658};
  constexpr double r2 = 1.0;
...
QUIZ_CASE(regression_quartic) {
  ...
  static_assert(std::size(x) == std::size(y), "Column sizes are different");
  constexpr CoefficientsType coefficients = {0.59998, -42.9998, 21.5015,
                                             3.09232, -0.456824};
  constexpr double r2 = 1.0;
...
QUIZ_CASE(regression_logarithmic) {
  ...
  constexpr CoefficientsType coefficients1 = {-6.81679, 3.19383};
  ...
  constexpr CoefficientsType coefficients2 = {10.0, -4.0};
  constexpr double r2 = -1.0;
...
QUIZ_CASE(regression_exponential) {
  ...
  static_assert(std::size(x) == std::size(y), "Column sizes are different");
  constexpr CoefficientsType coefficients = {-3.4, 0.8};
  constexpr double r = 1.0;
  constexpr double r2 = 1.0;
...
QUIZ_CASE(regression_exponential_2) {
  ...
  static_assert(std::size(x) == std::size(y), "Column sizes are different");
  constexpr CoefficientsType coefficients = {3000, .1};
  constexpr double r = 1.0;
  constexpr double r2 = 1.0;
...
QUIZ_CASE(regression_exponential_3) {
  ...
  static_assert(std::size(x) == std::size(y), "Column sizes are different");
  constexpr CoefficientsType coefficients = {-1, -1};
  constexpr double r = -1.0;
  constexpr double r2 = 1.0;
...
QUIZ_CASE(regression_exponential_4) {
  ...
  static_assert(std::size(x) == std::size(y), "Column sizes are different");
  constexpr CoefficientsType coefficients = {3.4641, -0.179};
...
QUIZ_CASE(regression_exponential_5) {
  ...
  static_assert(std::size(x) == std::size(y), "Column sizes are different");
  constexpr CoefficientsType coefficients = {1.41421, 0.0};
...
QUIZ_CASE(regression_exponential_abx) {
  ...
  static_assert(std::size(x) == std::size(y), "Column sizes are different");
  constexpr CoefficientsType coefficients = {1, 2};
  constexpr double r = 1.0;
  constexpr double r2 = 1.0;
  constexpr double sr = 0.0;
...
QUIZ_CASE(regression_power) {
  ...
  static_assert(std::size(x1) == std::size(y1), "Column sizes are different");
  constexpr CoefficientsType coefficients1 = {71.8, 2.7};
  constexpr double r1 = 1.0;
  constexpr double r21 = 1.0;
  ...
  static_assert(std::size(x2) == std::size(y2), "Column sizes are different");
  constexpr CoefficientsType coefficients2 = {2.63994478, -0.22182701};
  ...
  constexpr CoefficientsType coefficients3 = {-2.0, -2.0};
  ...
  constexpr CoefficientsType coefficients4 = {10.0, 0};
...
QUIZ_CASE(regression_median_0) {
  ...
  static_assert(std::size(x) == std::size(y), "Column sizes are different");
  constexpr CoefficientsType coefficients = {NAN, NAN};
...
QUIZ_CASE(regression_median_1) {
  ...
  constexpr double y[] = {4.0, 3.0, 2.0};
  static_assert(std::size(x) == std::size(y), "Column sizes are different");
  constexpr CoefficientsType coefficients = {-1.0, 5.0};
  constexpr double sr = 0.0;
  assert_regression_is(x, y, std::size(x), Model::Type::Median, coefficients,
                       NAN, NAN, sr);
}
...
QUIZ_CASE(regression_median_2) {
  ...
  static_assert(std::size(x) == std::size(y), "Column sizes are different");
  constexpr CoefficientsType coefficients = {2.0, -7.0};
...
void assert_trigonometric_regression_is(
  ...
  for (int i = 0; i < k_numberOfUnits; ++i) {
    ...
    CoefficientsType coefficientsUnit = {
...
QUIZ_CASE(regression_trigonometric_6) {
  ...
  constexpr CoefficientsType coefficients = {25.611, 0.5090, -2.0685, 56.880};
...
QUIZ_CASE(regression_trigonometric_7) {
  ...
  constexpr CoefficientsType coefficients = {7.0226, 0.6281, -1.5705, 7.999};
...
QUIZ_CASE(regression_trigonometric_8) {
  ...
  constexpr CoefficientsType coefficients = {0.6606, 0.4912, -1.768, 1.393};
...
QUIZ_CASE(regression_logistic) {
  ...
  static_assert(std::size(x1) == std::size(y1), "Column sizes are different");
  constexpr CoefficientsType coefficients1 = {6.0, 1.5, 4.7};
  ...
  static_assert(std::size(x2) == std::size(y2), "Column sizes are different");
  constexpr CoefficientsType coefficients2 = {64.9, 1.0, 297.4};
  ...
  static_assert(std::size(x3) == std::size(y3), "Column sizes are different");
  constexpr CoefficientsType coefficients3 = {12.0, 0.01, 1000.0};
  ...
  static_assert(std::size(x4) == std::size(y4), "Column sizes are different");
  constexpr CoefficientsType coefficients4 = {0.001, -3.0, -5.0};
  ...
  constexpr CoefficientsType coefficients5 = {0.88, 0.118, 18.8};
  ...
  constexpr CoefficientsType coefficients6 = {
  ...
  constexpr CoefficientsType coefficients7 = {3.56e8, 4.256,
                                              31.4};  // No target
